              ...
              body: Form(
                  ...
                  child: ListView(children: [
                    ...
                    ListTile(
                        ...
                        title: Text("Birthday"),
                        subtitle: Text(contactsModel.choseDate == null
                            ? ""
                            : contactsModel.choseDate),
                        trailing: IconButton(
                            icon: Icon(Icons.edit),
                            color: Colors.blue,
                            onPressed: () async {
          ...
          return AlertDialog(
            ...
            GestureDetector(
                ...
                onTap: () async {
                  ...
                  var cameraImage = await ImagePicker.platform
            ...
            GestureDetector(
                ...
                onTap: () async {
                  ...
                  var galleryImage = await ImagePicker.platform
